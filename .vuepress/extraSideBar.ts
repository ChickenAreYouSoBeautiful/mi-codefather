...
export default [
  ...
  },
  {
    ...
    popoverUrl:
      "/qrcode-codenav.png",
    popoverDesc: '<span style="font-size:0.8rem;font-weight:bold;"><span style="color:red;">本网站搜素"加入星球"有50返利</span></span>',
  },
  {
    title: "交流群",
  ...
  },
  {
    ...
    popoverTitle:
      '<span style="font-size:0.8rem;font-weight:bold;">扫码程序员鱼皮公众号，回复 <span style="color:red;">学习</span> 获取海量编程学习资源「无任何套路」</span>',
    popoverUrl:
